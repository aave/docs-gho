  ...
  return (
    <header className={clsx('hero', styles.heroBanner)}>
      <meta name="description" content="GHO is a decentralized multi-collateral stablecoin, transparent and native to the Aave Protocol. "/>
        ...
        <meta property="og:image" content="https://docs.gho.com/img/gho-docs-og.jpg"></meta>
        <meta name="twitter:card" content="summary_large_image"/>
        <meta property="twitter:domain" content="docs.gho.com"/>
        <meta property="twitter:url" content="https://docs.gho.com/"/>
        ...
        <meta name="twitter:image" content="https://docs.gho.com/img/gho-docs-og.jpg"/>
